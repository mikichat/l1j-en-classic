...
public class C_ItemUSe extends ClientBasePacket {
	...
	public C_ItemUSe(byte abyte0[], Client client) throws Exception {
		...
		if (itemId == 40088 || itemId == 40096 || itemId == 140088) {
			s = readS();
				...
				|| itemId == SCROLL_OF_ENCHANT_QUEST_WEAPON || itemId == 40077 || itemId == 40078 || itemId == 40126
				...
				|| itemId == 40931 || itemId == 40932 || itemId == 40933 || itemId == 40934 || itemId == 40935
				|| itemId == 40936 || itemId == 40937 || itemId == 40938 || itemId == 40939 || itemId == 40940
				|| itemId == 40941 || itemId == 40942 || itemId == 40943 || itemId == 40944 || itemId == 40945
				|| itemId == 40946 || itemId == 40947 || itemId == 40948 || itemId == 40949 || itemId == 40950
				|| itemId == 40951 || itemId == 40952 || itemId == 40953 || itemId == 40954 || itemId == 40955
				|| itemId == 40956 || itemId == 40957 || itemId == 40958 || itemId == 40964 || itemId == 49092
				|| itemId == 41426 || itemId == 41427 || itemId == 40075 || itemId == 41429 || itemId == 41430
				|| itemId == 41431 || itemId == 41432 || itemId == 49148) {
			l = readD();
		...
		_log.trace("request item use (obj) = " + itemObjid + " action = " + l + " value = " + s);
		if (itemId == 40077 || itemId == SCROLL_OF_ENCHANT_WEAPON || itemId == SCROLL_OF_ENCHANT_QUEST_WEAPON
				|| itemId == 40130 || itemId == 140130 || itemId == B_SCROLL_OF_ENCHANT_WEAPON
		...
		} else if (itemId == 40078 || itemId == SCROLL_OF_ENCHANT_ARMOR || itemId == 40129 || itemId == 140129
				|| itemId == B_SCROLL_OF_ENCHANT_ARMOR || itemId == C_SCROLL_OF_ENCHANT_ARMOR || itemId == 40127) {
			...
			if (minLvl != 0 && minLvl > pc.getLevel() && !pc.isGm()) {
				pc.sendPackets(new S_ServerMessage(318, String.valueOf(minLvl))); // You have to be at least level 'x'
																					// to use this item.
				return;
			} else if (maxLvl != 0 && maxLvl < pc.getLevel() && !pc.isGm()) {
				pc.sendPackets(new S_ServerMessage(673, String.valueOf(maxLvl))); // You have to be level 'x' or less to
																					// use this item.
				return;
			}
			...
			if (template.getType() == 0) {
				...
				pc.sendPackets(new S_ServerMessage(452, l1iteminstance.getLogName())); // 'item' was selected.
				...
				inventory.removeItem(l1iteminstance, 1);
				pc.sendPackets(new S_ServerMessage(822)); // You feel an unknown energy appear from a deep place in your
															// body.
				pc.save();
			} else if (itemId == 40033 || itemId == 40034 || itemId == 40035 || itemId == 40036 || itemId == 40037
					|| itemId == 40038) {
				useElixir(pc, itemId, l1iteminstance);
			} else if (itemId == POTION_OF_HEALING || itemId == CONDENSED_POTION_OF_HEALING || itemId == 40029) {
				UseHealingPotion(pc, 15, 189);
				inventory.removeItem(l1iteminstance, 1);
			} else if (itemId == 40022) {
				UseHealingPotion(pc, 20, 189);
				inventory.removeItem(l1iteminstance, 1);
			} else if (itemId == POTION_OF_EXTRA_HEALING || itemId == CONDENSED_POTION_OF_EXTRA_HEALING) {
				UseHealingPotion(pc, 45, 194);
				inventory.removeItem(l1iteminstance, 1);
			} else if (itemId == 40023) {
				UseHealingPotion(pc, 30, 194);
				inventory.removeItem(l1iteminstance, 1);
			} else if (itemId == POTION_OF_GREATER_HEALING || itemId == CONDENSED_POTION_OF_GREATER_HEALING) {
			...
			} else if (itemId == POTION_OF_HASTE_SELF || itemId == B_POTION_OF_HASTE_SELF || itemId == 40018
					|| itemId == 140018 || itemId == 40039 || itemId == 40040 || itemId == 40030 || itemId == 41338
					|| itemId == 41261 || itemId == 41262 || itemId == 41268 || itemId == 41269 || itemId == 41271
					|| itemId == 41272 || itemId == 41273 || itemId == 41342) {
				useGreenPotion(pc, itemId);
				inventory.removeItem(l1iteminstance, 1);
			} else if (itemId == POTION_OF_EMOTION_BRAVERY || itemId == B_POTION_OF_EMOTION_BRAVERY
					|| itemId == 41415) {
				if (pc.isKnight()) {
				...
				inventory.removeItem(l1iteminstance, 1);
			} else if (itemId == POTION_OF_MANA || itemId == B_POTION_OF_MANA || itemId == 40736) {
				useBluePotion(pc, itemId);
				inventory.removeItem(l1iteminstance, 1);
			} else if (itemId == POTION_OF_EMOTION_WISDOM || itemId == B_POTION_OF_EMOTION_WISDOM) {
				...
				useBlindPotion(pc);
				inventory.removeItem(l1iteminstance, 1);
			} else if (itemId == SCROLL_OF_POLYMORPH || itemId == IT_SCROLL_OF_POLYMORPH
				...
				inventory.removeItem(l1iteminstance, 1);
			} else if (itemId == 41143 || itemId == 41144 || itemId == 41145 || itemId == 49149 || itemId == 49150
				...
				for (L1ItemInstance eachItem : inventory.getItems()) {
					...
					L1Item normal = ItemTable.getInstance().getTemplate(id_normal);
					if (template == null) {
						continue;
					}
					if (inventory.checkItem(id_normal) && normal.isStackable()) {
						...
						inventory.updateItem(eachItem, L1PcInventory.COL_ITEMID);
				...
				if (!l1iteminstance1.isIdentified()) {
					...
					inventory.updateItem(l1iteminstance1, L1PcInventory.COL_IS_ID);
				}
				...
				if (diaryId >= 41038 && 41047 >= diaryId) {
					if ((ThreadLocalRandom.current().nextInt(99) + 1) <= Config.CREATE_CHANCE_DIARY) {
						...
						pc.sendPackets(new S_ServerMessage(158, l1iteminstance1.getName())); // Your 'item' evaporates.
					}
				...
				if (earing2Id >= 41173 && 41184 >= earing2Id) {
					...
					if (earing2Id >= (itemId + potion1) && (itemId + potion2) >= earing2Id) {
						if ((ThreadLocalRandom.current().nextInt(99) + 1) < Config.CREATE_CHANCE_MYSTERIOUS) {
							...
							pc.sendPackets(new S_ServerMessage(1310, l1iteminstance1.getName())); // It violently
																									// glowed, but did
																									// not evaporate.
																									// was 160
							inventory.removeItem(l1iteminstance, 1);
				...
				if (earing3Id >= 41161 && 41172 >= earing3Id) {
					if (earing3Id == (itemId + 230)) {
						if ((ThreadLocalRandom.current().nextInt(99) + 1) < Config.CREATE_CHANCE_PROCESSING) {
							...
							pc.sendPackets(new S_ServerMessage(158, l1iteminstance1.getName())); // Your 'item'
																									// evaporates.
						}
						inventory.removeItem(l1iteminstance1, 1);
						inventory.removeItem(l1iteminstance, 1);
			...
			} else if ((itemId >= 40859 && itemId <= 40898) && itemId != 40863 || itemId >= 49281 && itemId <= 49286) { // 40863
				...
				if (spellsc_objid == 0 && l1iteminstance.getItem().getUseType() != 0
						&& l1iteminstance.getItem().getUseType() != 26 && l1iteminstance.getItem().getUseType() != 27) {
					return;
				}
				cancelAbsoluteBarrier(pc);
					...
					if (resobject instanceof L1PcInstance) {
						...
						if (L1World.getInstance().getVisiblePlayer(target, 0).size() > 0) {
							for (L1PcInstance visiblePc : L1World.getInstance().getVisiblePlayer(target, 0)) {
								if (!visiblePc.isDead()) {
									pc.sendPackets(new S_ServerMessage(592)); // Your attempt at resurrection has failed
																				// because the location is occupied by
																				// someone else.
									return;
								}
							}
						...
						if (!(resobject instanceof L1TowerInstance)) {
							...
							if (npc instanceof L1PetInstance
								...
								for (L1PcInstance visiblePc : L1World.getInstance().getVisiblePlayer(npc, 0)) {
									if (!visiblePc.isDead()) {
										pc.sendPackets(new S_ServerMessage(592)); // Your attempt at resurrection has
																					// failed because the location is
				...
				if (pc.isCrown() || pc.isGm()) {
					if (itemId == 40226 && pc.getLevel() >= 15) {
						...
						pc.sendPackets(new S_ServerMessage(312)); // You can't learn that spell yet because your magic
																	// level is too low.
					}
				} else {
					pc.sendPackets(new S_ServerMessage(79)); // Nothing happened.
				...
				if (pc.isDragonKnight() || pc.isGm()) {
					...
					} else if (itemId >= 49107 && itemId <= 49111 && pc.getLevel() >= 30) {
						SpellBook5(pc, l1iteminstance, client);
					} else if (itemId >= 49112 && itemId <= 49116 && pc.getLevel() >= 45) {
						SpellBook5(pc, l1iteminstance, client);
					} else {
						pc.sendPackets(new S_ServerMessage(312)); // You can't learn that spell yet because your magic
																	// level is too low.
				...
				if (pc.isIllusionist() || pc.isGm()) {
					if (itemId >= 49117 && itemId <= 49121 && pc.getLevel() >= 10) {
						SpellBook6(pc, l1iteminstance, client);
					} else if (itemId >= 49122 && itemId <= 49126 && pc.getLevel() >= 20) {
						SpellBook6(pc, l1iteminstance, client);
					} else if (itemId >= 49127 && itemId <= 49131 && pc.getLevel() >= 30) {
						SpellBook6(pc, l1iteminstance, client);
					} else if (itemId >= 49132 && itemId <= 49136 && pc.getLevel() >= 40) {
						SpellBook6(pc, l1iteminstance, client);
					} else {
						pc.sendPackets(new S_ServerMessage(312)); // You can't learn that spell yet because your magic
																	// level is too low.
				...
				inventory.removeItem(l1iteminstance, 1);
				cancelAbsoluteBarrier(pc);
			} else if (itemId >= 40080 && itemId <= 40085 || itemId >= 40101 && itemId <= 40118
					|| itemId >= 40120 && itemId <= 40123 || itemId == 40125 || itemId >= 40801 && itemId <= 40898
					|| itemId >= 42001 && itemId <= 42033 || itemId >= 42035 && itemId <= 42100) { // various return
																									// scrolls
				if (pc.getMap().isEscapable() || pc.isGm()) {
					L1Teleport.teleport(pc, ((L1EtcItem) l1iteminstance.getItem()).get_locx(),
							((L1EtcItem) template).get_locy(), ((L1EtcItem) template).get_mapid(), 5, true);
					inventory.removeItem(l1iteminstance, 1);
				} else {
					pc.sendPackets(new S_ServerMessage(647)); // You cannot teleport in this location.
				}
				...
				if (partner_stat) {
					...
					if ((partner.getMapId() == 0 || partner.getMapId() == 4 || partner.getMapId() == 304)
							&& castle_area == false && pc.getMap().isEscapable()) {
						L1Teleport.teleport(pc, partner.getX(), partner.getY(), partner.getMapId(), 5, true);
					} else {
						pc.sendPackets(new S_ServerMessage(547)); // Your partner is playing in an area that you can't
																	// go.
					}
				} else {
				...
				if (pc.getMap().isUsePainwand()) {
					...
					int[] mobArray = { 45008, 45140, 45016, 45021, 45025, 45033, 45099, 45147, 45123, 45130, 45046,
							45092, 45138, 45098, 45127, 45143, 45149, 45171, 45040, 45155, 45192, 45173, 45213, 45079,
							45144 };
					...
					if (itemId == 40006 || itemId == 140006) {
						...
						inventory.updateItem(l1iteminstance, L1PcInventory.COL_CHARGE_COUNT);
					} else {
						inventory.removeItem(l1iteminstance, 1);
					}
				} else {
				...
				// if the target is a player, and either the target or attacker are in a safety
				// zone, deny.
				if (target instanceof L1PcInstance && (target.getMap().isSafetyZone(target.getLocation())
				...
				if (item != null) {
					...
					|| itemId == 40072 || itemId == 40073 || itemId == 140061 || itemId == 140062 || itemId == 140065
					|| itemId == 140069 || itemId == 140072 || itemId == 41296 || itemId == 41297 || itemId == 41266
					|| itemId == 41267 || itemId == 41274 || itemId == 41275 || itemId == 41276 || itemId == 41252
					|| itemId == 49040 || itemId == 49041 || itemId == 49042 || itemId == 49043 || itemId == 49044
				...
				useResolvent(pc, l1iteminstance1, l1iteminstance);
					...
					|| itemId == 49039 || itemId == 49289 || itemId == 49292 || itemId == 49293) {
				...
				pc.sendPackets(new S_ServerMessage(1141)); // We have been given the strength to attack the ghost full
															// of resentment.
				inventory.removeItem(l1iteminstance, 1);
				...
				pc.sendPackets(new S_SkillSound(pc.getId(), 190));
				pc.broadcastPacket(new S_SkillSound(pc.getId(), 190));
				pc.sendPackets(new S_ServerMessage(1142)); // We have been given the strength to attack General Hamel
															// full of resentment.
				inventory.removeItem(l1iteminstance, 1);
				...
				pc.sendPackets(new S_SkillSound(pc.getId(), 190));
				pc.broadcastPacket(new S_SkillSound(pc.getId(), 190));
				pc.sendPackets(new S_ServerMessage(1140)); // We have been given the strength to attack the cursed
															// Exorcist Saell.
				inventory.removeItem(l1iteminstance, 1);
				...
				if (locX != 0 && locY != 0) {
					...
					if (l1iteminstance.getCount() < 1) {
						pc.sendPackets(new S_ServerMessage(329, l1iteminstance.getLogName())); // You do not have
																								// 'item'.
					} else {
						pc.sendPackets(new S_ServerMessage(74, l1iteminstance.getLogName())); // You cannot use 'item'.
					}
	...
	// TODO: Move to L1PcInstance.
	private static void addStat(final L1PcInstance pc, L1Attribute stat, byte amount) {
		switch (stat) {
		case Str:
	...
	private static L1Attribute[] elixirs = { L1Attribute.Str, L1Attribute.Con, L1Attribute.Dex, L1Attribute.Int,
			L1Attribute.Wis, L1Attribute.Cha };
	private static final int FirstElixirId = 40033;

	// TODO: deal with throws bs.
	private static void useElixir(final L1PcInstance pc, final int itemId, final L1ItemInstance elixir)
			throws Exception {
		L1Attribute attribute = elixirs[itemId - FirstElixirId];
		if (pc.getElixirStats() >= 5 || getBaseStat(pc, attribute) >= 35) {
			pc.sendPackets(new S_ServerMessage(481)); // The maximum value you can get for one attribute is 35. Please
	...
	private static boolean validClass(final L1PcInstance pc, final L1Item item) {
		return pc.isGm() || pc.isCrown() && item.isUseRoyal() || pc.isKnight() && item.isUseKnight()
				|| pc.isElf() && item.isUseElf() || pc.isWizard() && item.isUseMage()
				|| pc.isDarkelf() && item.isUseDarkelf() || pc.isDragonKnight() && item.isUseDragonknight()
				|| pc.isIllusionist() && item.isUseIllusionist();
	}
	...
	private static boolean validLevel(final L1PcInstance pc, final L1Item item) {
		...
		if (min != 0 && min > pc.getLevel()) {
			pc.sendPackets(new S_ServerMessage(318, String.valueOf(min))); // You have to be at least level 'x' to use
																			// this item.
			return false;
		}
		if (max != 0 && max < pc.getLevel()) {
			pc.sendPackets(max < 50 ? new S_PacketBox(S_PacketBox.MSG_LEVEL_OVER, max)
					: new S_SystemMessage("You must be at or below level " + max + " to use this item."));
			return false;
		}
		return true;
	}
	...
	private void useBlindPotion(L1PcInstance pc) {
		...
		pc.sendPackets(new S_CurseBlind(pc.hasSkillEffect(STATUS_FLOATING_EYE) ? 2 : 1));
		...
		if (equipeSpace && !armor.isEquipped()) {
			...
			if (type == 7 && activeChar.getWeapon() != null) {
				if (activeChar.getWeapon().getItem().isTwohandedWeapon()) {
					activeChar.sendPackets(new S_ServerMessage(129)); // You cannot wear a shield while wielding a
																		// two-handed weapon.
					return;
				}
			}
			...
			if (type == 3 && pcInventory.getTypeEquipped(2, 4) >= 1) {
				activeChar.sendPackets(new S_ServerMessage(126, "$224", "$225")); // You cannot wear Shirt over Cloak.
				return;
			} else if ((type == 3) && pcInventory.getTypeEquipped(2, 2) >= 1) {
				activeChar.sendPackets(new S_ServerMessage(126, "$224", "$226")); // You cannot wear Shirt over Armor.
				return;
			} else if ((type == 2) && pcInventory.getTypeEquipped(2, 4) >= 1) {
				activeChar.sendPackets(new S_ServerMessage(126, "$226", "$225")); // You cannot wear Armor over Cloak.
				return;
			}
	...
	private void useWeapon(L1PcInstance activeChar, L1ItemInstance weapon) {
		...
		if (activeChar.getWeapon() == null || !activeChar.getWeapon().equals(weapon)) {
			...
			if (weapon.getItem().isTwohandedWeapon() && pcInventory.getTypeEquipped(2, 7) >= 1) {
				activeChar.sendPackets(new S_ServerMessage(128)); // You cannot wield a two-handed weapon while holding
																	// a shield.
				return;
			}
		}
		...
		if (weapon.getItemId() == 200002) {
			activeChar.sendPackets(new S_ServerMessage(149, weapon.getLogName())); // The 'item' is stuck to your hand!
		}
		...
		if (pc.isGm()) {
			...
			if (pc.isKnight()) {
				if (itemId >= 45000 && itemId <= 45007 && level >= 50) {
					...
					pc.sendPackets(new S_ServerMessage(312)); // You can't learn that spell yet because your magic level
																// is too low.
				} else {
					pc.sendPackets(new S_ServerMessage(79)); // Nothing happened.
				}
	...
	private boolean isLearnElfMagic(L1PcInstance pc) {
		...
		int y = pc.getY();
		int map = pc.getMapId();
		return x >= 32786 && x <= 32797 && y >= 32842 && y <= 32859 && map == 75
				|| pc.getLocation().isInScreen(new Point(33055, 32336)) && map == 4;
	}
	...
	private void SpellBook1(L1PcInstance pc, L1ItemInstance l1iteminstance, Client client) {
		String s = "";
		int i = 0;
		int j = 0;
		int k = 0;
	...
	private void SpellBook3(L1PcInstance pc, L1ItemInstance l1iteminstance, Client client) {
		String s = "";
		int i = 0;
		int j = 0;
		int k = 0;
		...
		for (int j6 = 87; j6 <= 91; j6++) {
			L1Skill l1skills = SkillTable.getInstance().findBySkillId(j6);
			String s1 = (new StringBuilder()).append("TechnicalDocument(").append(l1skills.getName()).append(")")
					.toString();
			if (l1iteminstance.getItem().getName().equalsIgnoreCase(s1)) {
				int l6 = l1skills.getSkillLevel();
				int i7 = l1skills.getId();
	...
	private void SpellBook4(L1PcInstance pc, L1ItemInstance l1iteminstance, Client client) {
		String s = "";
		int i = 0;
		int j = 0;
		int k = 0;
	...
	private void SpellBook5(L1PcInstance pc, L1ItemInstance l1iteminstance, Client client) {
		String s = "";
		int i = 0;
		int j = 0;
		int k = 0;
	...
	private void SpellBook6(L1PcInstance pc, L1ItemInstance l1iteminstance, Client client) {
		String s = "";
		int i = 0;
		int j = 0;
		int k = 0;
	...
	private static boolean properPlaceForToiCharm(final L1PcInstance pc, int charmId) {
		...
		case 40293: // 11,51F amulet
			return x >= 32816 && x <= 32821 && y >= 32778 && y <= 32783 && map == 101;
		case 40290:
		case 40294: // 21,61F amulet
			return x >= 32815 && x <= 32820 && y >= 32815 && y <= 32820 && map == 101;
		case 40291:
		case 40295: // 31,71F amulet
			return x >= 32779 && x <= 32784 && y >= 32778 && y <= 32783 && map == 101;
		case 40292:
		case 40296: // 41,81F amulet
			return x >= 32779 && x <= 32784 && y >= 32815 && y <= 32820 && map == 101;
		case 40297: // 91F amulet
			return x >= 32706 && x <= 32710 && y >= 32909 && y <= 32913 && map == 190;
		default:
			return false;
		}
	}

	private static void useToiTeleportAmulet(L1PcInstance pc, int itemId, L1ItemInstance item) {
		if (properPlaceForToiCharm(pc, itemId)) {
			L1Item template = item.getItem();
			L1Teleport.teleport(pc, template.get_locx(), template.get_locy(), template.get_mapid(), 5, true);
		} else
			pc.sendPackets(new S_ServerMessage(79)); // Nothing happened.
	}
	...
	private boolean sendLetter(L1PcInstance pc, String name, L1ItemInstance item, boolean isFailureMessage) {
		...
		if (target != null) {
			if (target.getInventory().checkAddItem(item, 1) == L1Inventory.OK) {
				...
				if (isFailureMessage) {
					pc.sendPackets(new S_ServerMessage(942)); // The other party's belongings are too heavy for you to
																// give anymore.
				}
				return false;
			}
			...
			if (CharacterTable.doesCharNameExist(name)) {
				try {
					...
					if (storage.getItemCount(targetId) < 180) {
						...
						if (isFailureMessage) {
							pc.sendPackets(new S_ServerMessage(942)); // The other party's belongings are too heavy for
																		// you to give anymore.
						}
						return false;
					}
		...
		if (pc.getMap().isFishingZone(fishX, fishY)) {
			if (pc.getMap().isFishingZone(fishX + 1, fishY) && pc.getMap().isFishingZone(fishX - 1, fishY)
				...
				if (fishX > pc.getX() + rodLength || fishX < pc.getX() - rodLength) {
					...
					pc.setFishing(true);
					long time = System.currentTimeMillis() + 10000 + ThreadLocalRandom.current().nextInt(5) * 1000;
	...
	private void useResolvent(L1PcInstance pc, L1ItemInstance item, L1ItemInstance resolvent) {
		...
		L1Item template = item.getItem();
		int crystalCount = ResolventTable.getInstance().getCrystalCount(template.getItemId());
		if (crystalCount == 0 || (template.getType2() == 1 || template.getType2() == 2)
	...
	private void useMagicDoll(L1PcInstance pc, int itemId, int itemObjectId) {
		...
		if (isAppear) {
			...
			} else if (itemId == 49289) {
				npcId = 80153;
				dollType = L1DollInstance.DOLLTYPE_YETI;
			} else if (itemId == 49292) {
				npcId = 80156;
	...
	// Keep these in order!
	private static final Recipe[] recipes = new Recipe[] { new Recipe(new int[] { 40057 }, 41277, 41285),
			new Recipe(new int[] { 41275 }, 41278, 41286), new Recipe(new int[] { 41263, 41265 }, 41279, 41287),
			new Recipe(new int[] { 41274, 41267 }, 41280, 41288),
			new Recipe(new int[] { 40062, 40069, 40064 }, 41281, 41289),
			new Recipe(new int[] { 40056, 40060, 40061 }, 41282, 41290), new Recipe(new int[] { 41276 }, 41283, 41291),
			new Recipe(new int[] { 40499, 40060 }, 41284, 41292), new Recipe(new int[] { 49040, 49048 }, 49049, 49057),
			new Recipe(new int[] { 49041, 49048 }, 49050, 49058),
			new Recipe(new int[] { 49042, 41265, 49048 }, 49051, 49059),
			new Recipe(new int[] { 49043, 49048 }, 49052, 49060), new Recipe(new int[] { 49044, 49048 }, 49053, 49061),
			new Recipe(new int[] { 49045, 49048 }, 49054, 49062), new Recipe(new int[] { 49046, 49048 }, 49055, 49063),
	...
	private void writeScroll(final L1PcInstance pc, int scrollId, int spellId) {
		if (!IntArrays.contains(scrollIds, scrollId) || spellId > scrollLimits[scrollId - scrollIds[0]]) {
			pc.sendPackets(new S_ServerMessage(591)); // The scroll is too weak to record that strong of a spell.
			return;
		}

		L1ItemInstance scroll = ItemTable.getInstance().createItem(40859 + spellId);
		if (scroll == null)
			return;
		...
		if (inventory.checkAddItem(scroll, 1) == L1Inventory.OK) {
			...
			if (skill.getItemConsumeId() != 0) {
				if (!pc.getInventory().checkItem(skill.getItemConsumeId(), skill.getItemConsumeCount())) {
			...
			pc.setLawful(lawful);
			if (skill.getItemConsumeId() != 0) {
				inventory.consumeItem(skill.getItemConsumeId(), skill.getItemConsumeCount());
			}
